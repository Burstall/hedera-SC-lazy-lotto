...
(async () => {
	...
	if (!poolId || !numEntries) {
		console.error('Usage: node buyAndRedeemEntry.js <poolId> <numEntries>');
		process.exit(1);
	}
	...
	const tx = await contractExecuteFunction(client, contractId, params, 0, 'buyAndRedeemEntry', 200000);
	await tx.getReceipt(client);
	console.log('buyAndRedeemEntry executed successfully.');
})();
