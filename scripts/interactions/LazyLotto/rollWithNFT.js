...
(async () => {
	...
	if (!poolId || !nftToken || !nftSerial) {
		console.error('Usage: node rollWithNFT.js <poolId> <nftToken> <nftSerial>');
		process.exit(1);
	}
	...
	const tx = await contractExecuteFunction(client, contractId, params, 0, 'rollWithNFT', 200000);
	await tx.getReceipt(client);
	console.log('rollWithNFT executed successfully.');
})();
