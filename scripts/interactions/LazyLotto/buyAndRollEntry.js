...
(async () => {
	...
	if (!poolId || !numEntries) {
		console.error('Usage: node buyAndRollEntry.js <poolId> <numEntries>');
		process.exit(1);
	}
	...
	const tx = await contractExecuteFunction(client, contractId, params, 0, 'buyAndRollEntry', 200000);
	await tx.getReceipt(client);
	console.log('buyAndRollEntry executed successfully.');
})();
