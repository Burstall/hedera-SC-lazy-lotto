...
// filepath: d:\\github\\hedera-SC-lazy-lotto\\contracts\\HTSLazyLottoLibrary.sol
...
library HTSLazyLottoLibrary {
    ...
    function mintAndTransferNFT(
        ...
        if (
            responseCode != HTSLazyLottoLibrary.SUCCESS ||
        ...
        responseCode = HTSLazyLottoLibrary.transferNFTs(
            token,
            senderAddresses,
            receiverAddresses,
            serialNumbers
