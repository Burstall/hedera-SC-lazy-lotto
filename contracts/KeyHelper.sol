...
abstract contract KeyHelper {
    address private supplyContract;
    ...
    function getDuplexKeyType(
        ...
        keyType = setBit(keyType, uint8(firstType));
        keyType = setBit(keyType, uint8(secondType));
    }

    function getAllKeyTypes() internal pure returns (uint256 keyType) {
        keyType = setBit(keyType, uint8(KeyType.ADMIN));
        keyType = setBit(keyType, uint8(KeyType.KYC));
        ...
        keyType = setBit(keyType, uint8(KeyType.FEE));
        keyType = setBit(keyType, uint8(KeyType.PAUSE));
    }
